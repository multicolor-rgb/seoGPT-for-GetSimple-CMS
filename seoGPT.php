...
register_plugin(
	...
	'Plugin for SEO text based on OpenAI', //Plugin description
	'pages', //page type - on which admin tab to display
	'seoGPT'  //main function (administration)
);

# add a link in the admin tab 'theme'
add_action('pages-sidebar','createSideMenu',array($thisfile,'SeoGPT Settings'));
...
echo '<b style="margin:10px 0;font-size:1.2rem;margin-top:20px;display:block;">Answer bots</b>
